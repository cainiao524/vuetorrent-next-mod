...
import { getColorFromName, getRatioColor, getTagPaletteColor, getTorrentStateColor, getTorrentStateValue } from './colors'
...
test('helpers/colors/getTagPaletteColor', () => {
  expect(getTagPaletteColor('foo', true)).toEqual({ background: '#3F6212', foreground: '#D9F99D' })
  expect(getTagPaletteColor('foo', false)).toEqual({ background: '#ECFCCB', foreground: '#3F6212' })
  expect(getTagPaletteColor('bar', true)).toEqual({ background: '#0C4A6E', foreground: '#BAE6FD' })
  expect(getTagPaletteColor('baz', false)).toEqual({ background: '#CFFAFE', foreground: '#155E75' })
})
