...
describe('BaseCard.vue', () => {
  ...
  test('applies surface-variant color when active is true', () => {
    const wrapper = mount(BaseCard, {
      props: {
        title: 'Active Card',
        icon: 'mdi-active',
    ...
    expect(wrapper.findComponent({ name: 'v-sheet' }).props('color')).toBe('surface-variant')
  })

  test('applies surface color when active is false', () => {
    const wrapper = mount(BaseCard, {
      props: {
        title: 'Inactive Card',
        icon: 'mdi-inactive',
    ...
    expect(wrapper.findComponent({ name: 'v-sheet' }).props('color')).toBe('surface')
  })
  ...
  test('renders slot content with value prop', () => {
    ...
    expect(wrapper.find('[data-testid="card-content"]').text()).toContain('SlotValue')
  })
})
