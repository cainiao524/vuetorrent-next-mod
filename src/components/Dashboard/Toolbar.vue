...
<template>
  ...
  <div class="d-flex mb-2 align-center">
    <div class="segmented-control">
      ...
      <v-tooltip :text="t('dashboard.displayMode.list')" location="top">
        <template #activator="{ props }">
          <v-btn :class="{ 'segmented-active': isListView }" icon="mdi-view-list" variant="plain" v-bind="props" @click="displayMode = DashboardDisplayMode.LIST" />
        </template>
      </v-tooltip>
      <v-tooltip :text="t('dashboard.displayMode.grid')" location="top">
        <template #activator="{ props }">
          <v-btn :class="{ 'segmented-active': isGridView }" icon="mdi-view-grid" variant="plain" v-bind="props" @click="displayMode = DashboardDisplayMode.GRID" />
        </template>
      </v-tooltip>
      <v-tooltip :text="t('dashboard.displayMode.table')" location="top">
        <template #activator="{ props }">
          <v-btn :class="{ 'segmented-active': isTableView }" icon="mdi-table" variant="plain" v-bind="props" @click="displayMode = DashboardDisplayMode.TABLE" />
        </template>
      </v-tooltip>
