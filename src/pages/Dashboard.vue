...
const { paginatedTorrents, currentPage, pageCount, isSelectionMultiple, selectedTorrents, displayMode, torrentCountString } = storeToRefs(dashboardStore)
...
<template>
  <div class="dashboard-page px-3 px-sm-6">
    <DashboardSummary class="mb-8" />

    <div class="dashboard-heading">
      <div>
        <h1 class="dashboard-heading__title">{{ t('dashboard.title') }}</h1>
        <p class="dashboard-heading__subtitle">{{ torrentCountString }}</p>
      </div>
    </div>
